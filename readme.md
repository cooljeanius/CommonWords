...
Another Intro To C assignment. This one goes through a file called "input.dat", searches for common words, and outputs the results to a file called "output.dat".
